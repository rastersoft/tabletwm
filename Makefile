...
tabletwm: tabletwm.o globals.o init.o actions.o support.o
	$(LN) -o tabletwm tabletwm.o globals.o init.o actions.o support.o `pkg-config --libs xcb xcb-util xcb-randr`
...
support.o: support.c support.h globals.h
	$(CC) $(CFLAGS) -o support.o support.c `pkg-config --cflags xcb xcb-util`
